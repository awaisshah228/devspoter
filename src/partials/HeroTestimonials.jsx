      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          <div className="max-w-3xl mx-auto text-center">
            {/* <h1 className=" h1 font-red-hat-display mb-4" data-aos="fade-down">Our Services</h1> */}
            <h4 className="h4 font-red-hat-display mb-4" data-aos="fade-down">Web Development Solutions to business firms & entrepreneurs to Drive Results, Ensuring Rapid Development</h4>
