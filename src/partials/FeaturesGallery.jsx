      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-6 pb-12 md:pt-8 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-red-hat-display mb-4">Solutions which provide value to the world.</h2>
            <p className="text-xl text-gray-600 dark:text-gray-400">Our dedicated developers are welcoming new challenges everyday since we stepped in.</p>
          </div>
