      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-red-hat-display mb-4">Solutions that make a difference</h2>
            <p className="text-xl text-gray-600 dark:text-gray-400">
              At Dev Disruptors, we are all about excellence, innovation, and passion for creating the best software development solutions for our clients. As of now, we have dealt with a plethora of both on and off-shore clients and have a global satisfied client base.

              We provide a wide range of services covering design and development for both mobile and web platforms, ERPs, CRMs, e-commerce solutions, QA testing, and user interface design.

              Throughout these years, we have built many B2B and B2C apps with solutions based on high volumes of data, and artificial intelligence in industries as widely diverse as financial services, retail, telecommunications, healthcare and e-commerce.
            </p>
          </div>
                ...
                <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
                  <article className="p-6 bg-white dark:bg-gray-800 shadow-2xl flex flex-col">
                    ...
                    <div className="text-gray-600 dark:text-gray-400 grow">
                      <p>We believe planning is of utmost importance in starting any development endeavor. We use modern mockup and planning tools to get a blueprint before starting development.</p>
                    </div>
                  ...
                  <article className="p-6 bg-white dark:bg-gray-800 shadow-2xl flex flex-col">
                    ...
                    <div className="text-gray-600 dark:text-gray-400 grow">
                      <p>We gather the best of our creative minds together to come up with the finest creative solutions with the intersection of ideas of working in different businesses and industries.</p>
                    </div>
                    <a className="inline-flex items-center font-medium text-teal-500 hover:underline mt-2" href="#0">
                      <span>Learn more</span>
                      <svg className="w-3 h-3 shrink-0 mt-px ml-2" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <article className="p-6 bg-white dark:bg-gray-800 shadow-2xl flex flex-col">
                    <header>
                      <h3 className="h4 font-red-hat-display mb-1">
                        <a href="#0">Automation</a>
                      </h3>
                    </header>
                    <div className="text-gray-600 dark:text-gray-400 grow">
                      <p>We automate the boring DevOps processes so that the developers and client could focus to work together in designing the best possible solution for the users.</p>
                    </div>
                    <a className="inline-flex items-center font-medium text-teal-500 hover:underline mt-2" href="#0">
                      <span>Learn more</span>
                      <svg className="w-3 h-3 shrink-0 mt-px ml-2" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
