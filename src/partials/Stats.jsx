...
function Stats() {
  return (
    <section className="relative md:my-16">
...
<div className="relative flex flex-col items-center">
  <div aria-hidden="true" className="absolute h-0.5 bg-gradient-to-r from-white via-gray-300 to-white dark:from-gray-900 dark:via-gray-700 dark:to-gray-900 hidden md:block" style={{ width: 'calc(100% - 96px)', left: 'calc(50% + 64px)', top: '40px' }}></div>
  <div className="relative w-20 h-20 mb-3 flex ">
  ...
  <div className="sm:text-lg font-medium dark:text-gray-300">35+ Happy Client</div>
</div>
...
<div className="relative flex flex-col items-center">
  ...
  <div className="sm:text-lg font-medium dark:text-gray-300 text-center">50+ Web App delivered</div>
</div>
...
<div className="relative flex flex-col items-center">
  ...
  <div className="sm:text-lg font-medium dark:text-gray-300">50+ Technical Expert</div>
</div>
